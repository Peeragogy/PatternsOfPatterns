...
Design patterns could be seen to be a paragon of the “technical
mindset” (/ibid/.), a growing repository
of technical fixes.  However, the pattern methods seem to be more than
this.  Perhaps they are also part of the required worldview just
mentioned.  It is certainly an interesting coincidence that the
pattern discourse is contemporaneous with the climate crisis, both
getting an official start in 1979.

Patterns may help us “imagine how human communities might come to
...
threatens life on Earth” (/ibid/.).  As we begin this exploration it is
useful to juxtapose our exploration of patterns against a
...
other, in order to work together across scales.  We can also reflect
that while science fiction can provide a `thinking machine'
cite:Doherty2020, it cannot by itself provide historically robust alternatives
...
worth noting that this is by no means a complete critique.  As an
...
be immune from such concerns?  VanDrunen’s criticisms are useful for our
purposes not because they provide the last word, but because they points to the
importance of considering the deeper layers in developing a concept
or approach.  There may also be conflicts at the deeper layers.
...
other methods that fulfill the same purpose can certainly be used.
