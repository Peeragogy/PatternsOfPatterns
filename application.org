...
** Scenario II. Pattern languages move to free/libre/open source licensing.
...
and transdisciplinary in their approach and multivalently accessible
and accommodating in their development — is a form of hegemonic power
asserting itself inside the methods we’ve described. After all, the
notion of gift culture has been critiqued on that basis
cite:Mallard2019; would we expect pattern-theoretic culture to be
exempt or innocuous?
