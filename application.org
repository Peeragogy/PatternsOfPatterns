...
AAR that would make it a more open ended and horizontal in nature.  We
...
loose hierachical structures.  As such, both projects inherit
...
use this recent history to frame future work building on the case study and analysis developed above.
...
of actual world, say, "build a house atop this hill" or "make a
celebration song".
...
instrumentalists for performance.  Alexander points that there is a
...
one that includes concepts like like ‘\emph{ballabile}’ (to indicate that
...
problem.  Alexander proposed a maximum entropy method for carring out
