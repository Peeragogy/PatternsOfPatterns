...
- DPL adds the /motor element/ of action planning and orchestration.
...
*** Pacman Action Review
  :PROPERTIES:
  :UNNUMBERED: t
  :END:
[JC: Just doing some sketching here to provide a place to sum up our key findings.]
1. *[Pacman consumes dots and fruits]* — Humans and other living beings are capable of learning creative ways to overcome frequent and unpleasant difficulties.  Because the notion of “need” is hard to fully pin down, as a working assumption we will follow Alexander and “replace the idea of need by the idea of what people are trying to do” cite:alexander1970a.  However, we will cross-check our work against an established catalogue of needs in an Appendix.
2. *[Ghosts disable Pacman]* — In a world in which living beings are out of balance with the systems they live in, they cannot survive.
3. *[When Pacman eats power pills, Pacman can frighten ghosts]* — We can upgrade our abilities to engage with damaging historical legacies.
4. *[When ghosts are frightened, they retreat and cannot harm Pacman for a while]* — Difficulties will inevitable resurge due to the complex nature of the world we are living in.
5. *[Once all of the available dots have been consumed, the speed advances and we begin again]* — Our ability to deal with problems on the small scale of ‘case studies’ can be hooked up with the large scale of ‘historical trends’.
...
the Open Source Initiative’s definition — which is centred on the premise that
...
with known peeragogy design patterns like \textsc{Roadmap} (see
