...
Design patterns provide a general-purpose design methodology
cite:Corneli2018: however, the high-level evolution of this method in
response to criticism, innovation, technical developments, and
long-term cultural change has not been previously studied in an
integrated manner.  We use Causal Layered Analysis
cite:inayatullah1998b,inayatullah2004causal to surface the direction
of travel of pattern language methods, drawing on foundational
literature and empirical observation.  We identify trends towards
transdisciplinary thinking and large-scale collaboration, and connect
Alexander’s views on wholeness with the Nietzschean metaphysical
tradition.

This analysis provides the background for a case study on recent
developments within a peer learning network.  Specifically, we focus
in on the project planning and management techniques used in a seminar
about the multivalent relationship between the Emacs editor and
research.  We describe how we have used patterns together with other
methods to develop a sense of direction for the project, and to help
it interoperate with related efforts.  This case study provides a
detailed practical example that other projects across the pattern
language space may wish to emulate.  We develop this perspective in a
discussion of several potential scenarios for the future of
pattern-theoretic work.
...
In Section [[Discussion]] we look back over the survey and case study and
...
strategy we propose could lead to more satisfactory outcomes on
problems at this scale.  We look at four scenarios for the future
development of pattern-theoretic methods.  In Section [[Conclusion]] we
present a PAR for the paper as a whole: this is offered as an example
of a potential ‘best practice’ for pattern authors, on the view that
widespread adoption of this method would help improve collaboration
within the design patterns community.
