...
That said, this line of thinking leads us to ask if
there is a form of hegemonic power lurking inside the methods
...
- RP: One of our goals was to make the connection between futures and
  ...
  set of further scenarios for ERG, peeragogy, and so on.
- CD: Keep in mind that these are patterns people but not CLA people:
  we should make sure that we have presented CLA in a way that they
  grasp.
...
- We believe we have an answer to Alexander’s question.  We’re not
  ...
  better so that we can coordinate in parallel.
