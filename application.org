...
reality as circumstances evolve.  Integrating PARs with other
methods, we can, e.g., use them to check how effective our design
...
DPLs allows the structure to be customized to our particular
...
example, Table \ref{exemplar-par} is the first PAR prepared by the Emacs Research
...
Inayatullah developed
Causal Layered Analysis (CLA) cite:inayatullah1998b,inayatullah2004causal as a research methodology that based
...
#+CAPTION: 🍕 Example, System layer: Mom has practical experience of how restaurants operate coming from the summers she spent working in a diner.  Pop is handy with tools, so he can set up and maintain restaurant equipment.  The policies of the town are favorable to small businesses.  The demographics of the town include a good number of busy families with children who form a reliable customer base for the pizzeria.  As the pace of economic recovery picks up, townspeople have more money and less time so they frequent restaurants and order takeout more frequently.  The restaurant maintains good connections with local suppliers, and Mom and Pop are proud of the high quality and affordable dining experience they can offer.  The upshot is that, business is booming: but in its own way this only contributes to their stress.  Many arguments ensue, about who should be managing the restaurant, on what days, where to get the ingredients, and how much they should spend.  They strongly desire to “sort it out”.  However, after a few discussions, they find it difficult to tease out the real reason for their dissagreements and end up even more frustrated.
[[./tomato.jpg]]
...
- *Analysis*: Study archetypical symbols and the myths and rituals within which they participate.
- *Literature*: Poetry, art, philology, anthropology, and Jungian analysts.

#+NAME: winter
#+ATTR_ORG: :width 700px
#+ATTR_HTML: :width 700px
#+ATTR_LATEX: :width .6\textwidth :placement [H]
#+CAPTION: 🍕 Example, Myth layer: Pop looks up to Thoreau and Emerson as personal heroes and knows /Walden/ and /Self-Reliance/ backwards and forwards.  Mom looks back to childhood memories of parents who loved cooking together and her memories evoke an age of innocence.  For her, the circle is a powerful symbol of wholeness and community: when she brings a pizza to children at the round tables of the restaurant, she feels like a mystagogue initiating the next generation.  The couple go to speak with a wise counsellor, in a consulting room filled with lovely plants.  Together, they put together a strategy that helps them to respond to the circumstances as they have evolved. They decide close the shop Monday through Wednesday, to spend time away from the business, to develop their own ideas, to enjoy hobbies like writing, woodwork, and painting — and to tend their garden together.  For Thursday through Sunday, they resolidify their intention make their work together a meditation on love.  Boosted by their time off, they prepare more innovative meals and, while the restaurant remains affordable, they are garnering excellent crit from foodies.
[[./olives.jpg]]
...
cite:handelman1998a. In short, the difference between these two elementary traversal stories suggests that the process of finding “the path that is capable of leading to a good structure” cite:alexander1999a may contain irreducible complexity, even when sharing the information is simple.
...
on the view that so far our thinking has developed rhizomatically,
underground, rather than fully in the public sphere.  This
analysis serves to contextualize our work relative to the PLoP and
...
minute 5).  A “living” pattern is, accordingly, attached to Next Steps that
would help to realise that pattern within a context; when we
don’t have any next steps, we put the pattern in a \textsc{Scrapbook}.]
We collate these next steps with known
...
who, along with others, have pointed out that that the open source
community may not be so open, in practical terms, to newcomers from all genders and ethnic
...
to generate new knowledge.  However, this could conflict with a notion of
library contents as read-only, or with the view that libraries
should be silent study spaces.
...
to take his remarks as mere metaphor.  Neither can we afford blythe
...
four scenarios we described above will be given serious thought by
members of the pattern community, along with possible dystopic
variants.  /Progress/ will become measurable through markers of debate
and perhaps through ensuing trial-and-error uptake or adaptation of
the methods we’ve described.
...
CLA could be seen to play the opposite role to PARs.  Metaphorically,
CLA integrates the tangent vectors that characterise the
observations we have gathered as we work together, and can be used to
reconstruct the shared meaning of our work.
...
This is one reason to think about how patterns — and other methods —
are contextualised.  This is a useful moment to examine how others
have gone about related things.
...
We woud like to draw the reader's attention to two diagrams from
Alexander's "Notes on the Synthesis of Form" which we have recopied
below.  In the first diagram, we have two columns corresponding to
context (sive problem) and form (sive solution) and three rows
corresponding to "actual world", "mental picture" and "formal
picture".  A design problem is posed at the level of actual world, say
"build a house atop this hill" or "make a celebration song".  It can
be solved at one of the three levels.

The most direct approach is to work in the actual world.  For
instance, a musician might pick up an instrument, start playing
something, try out different possibilities, modify notes or phrasings
to make it sound better, and so come up with a song.

At the level of "mental picture", a designer recieves design
requirements which describe the problem and produces a plan which
describes a solution.  For instance, the host of the party might take
...
to a composer who might might sit down at a desk away from and
instruments and write out a score which would later be handed to the
singer and instrumentalists for performance.  Alexander points that
there is a danger in this process since one no longer has the
immediate feedback which comes from working directly in the actual
world.

His proposed solution is to produce a formal picture of the mental
picture and instead work with that formal picture.  For Alexander,
this consists of a set-theoretic formalization of design requirements
and misfits.  For our example, it might take the form of music theory
(Chapter 1 Westergaard).  More generally, we employ a suitable
metalanguage to reason about the mental representation; this process
of reasoning can then take the place of the actual world feedback in
guiding and evaluating our designs.

(Why only three rows?  According to Goedel, any language which counts
can serve as its own metalanguage.)

The second diagram refers to the process of design at the "formal
picture" level.  The left panel represents the analytic process in
which one decomposes a design problem into subproblems and the right
panel represents the complementary synthetic pocess in which one
successively combines solutions to subproblems to arrive at a solution
to the original problem.  Alexander proposed a maximum entropy method
for carring out the analysis and, in later works, introduced design
patterns for use in the synthesis.

In this paper, we considered the problems of a group of people
organizing their activities.  The "actual world" approach would be
when a group takes a "seat of the pants" approach to dealing with
issues as they come up.  PAR is a technique for sketching a "mental
picture"; CLA and Peeragogy patterns are, respectively, techniques for
analysis and synthesis at the "formal picture" level.  Just as even a
talented musician without a solid grasp of music theory woud be hard
pressed to compose an augmentation canon or symphony, so too we
...
\begin{equation*}
  \xymatrix{
    \hbox{context} & \hbox{form} & \\
    *+[F]{C1}  \ar@{<->}[r] & *+[F]{F1} & \hbox {actual world}}
\end{equation*}
\vskip 10pt
\emph{A.~In this point there is a close relationship between content and form, and they evolve together.}
\vskip 10pt
\begin{equation*}
  \xymatrix{
    \hbox{context} & \hbox{form} \\
...
\end{equation*}
\vskip 10pt
\emph{B.~In this setting we add a mental picture $C2$ that abstracts from the context (e.g., design requirements).  This corresponds to $F2$ e.g., plans), and $F1$ abstracts further (e.g., a description of the plan).  This allows civilisation and specialisation, but there’s no direct link between $C1$ and $F1$.}
\vskip 10pt
\begin{equation*}
  \xymatrix{
    \hbox{context} & \hbox{form} & \\
...
\end{equation*}
\vskip 10pt
\emph{C.~Now we add a meta-language.}
\vskip 10pt
\begin{center}
...
\end{minipage}
\vskip 10pt
\emph{D.~At this level we have methods for actually doing the programming.}
\vskip 10pt
\end{center}
\end{figure}
#+END_EXPORT
...
** Maybe also have a look at AAR in business
** CLA and Action Research.
