...
small.
#+end_quote
We were concerned that, while the Cooling the Commons patterns
acknowledge “horizontal complexity” — through interlinked patterns —
...
technical issues at the systems level and did not acknowledge these
...
starting the day, then figuring out how to adapt them to the new
schedule.  A research strategy might be study how practices changed in
