...
content like that developed in the Analysis could be developed
further.  The Case Study applied the [[PLACARD][PLACARD]] method to Emacs Research
Group (ERG), which was convened following EmacsConf 2020.[fn::
https://emacsconf.org/2020/; the conference took place November 28th
and 29th of 2020.]  In our case, this analysis has allowed us to
develop a trajectory for the project.  As a broader point of
...
in a short presentation.  An example appears below:

| Litany    | SHOPPING STREET | People come and they have ideas about shopping.                     |                    |
| System    | GAMIFY          | Imagine if you to 3 shops and stamp a card you get a free BBQ.      | OUTDOOR COOKING    |
| Worldview | HISTORIAN       | They will bring their kids and want to teach them about the climate | OUTDOOR PLAY AREAS |
| Myth      | LOSS OF PRIVACY | Concern about security and this is a trade-off.                     |                    |

The /hoped for outcome/ would be that people can go on to make more
informed decisions about how people think about the world.  They may
go away thinking they need a better way to talk about these issues, so
that's OK.
