...
more fundamental analysis, and to use this to work towards a new level
...
integrates thinking with awareness and actien, and that works across
...
$$\textsc{PAR}+\textsc{CLA}+\textsc{DPL}=\textrm{PLACARD}$$
...
- What new /functionalities/ would broaden the applicabilty of Emacs?
...
- The methods, workflows, and tools we are developing help us carry out our own activities more throughly and efficiently and could be of interest outside the group. How could similar processes be useful to others who interact /with/ Emacs?
...
Tidwell questioned the non-user-centredness of much DPL discourse;
...
community—is that the four scenarios we developed will be given
...
the first instance, and making their work demonstrably more robust.
